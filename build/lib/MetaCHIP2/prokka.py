...
def prokka(args):
    ...
    if gnm_domain_txt is not None:
        if os.path.isfile(gnm_domain_txt) is True:
            ...
            print('%s not found, program exited!' % gnm_domain_txt)
            exit()
...
if __name__ == '__main__':
    ...
    parser.add_argument('-d',          required=False, default=None,           help='genome domain, Bacteria or Archaea')
