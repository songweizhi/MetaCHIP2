...
option_list = list(
  ...
  make_option(c("-g", "--grouping"), type="character", help="grouping file", metavar="character"),
  make_option(c("-f", "--label_font"), type="double", help="label fontsize on the tree plot", metavar="double"),
  make_option(c("-s", "--label_shift"),type="double",help="label shift on the tree plot",metavar="double"),
  make_option(c("-v", "--tree_height"),type="double",help="height of tree plot",metavar="double"));
